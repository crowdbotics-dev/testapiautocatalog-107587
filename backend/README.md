...
## Project Structure
    ...
    ├── testapiautocatalog_107587  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_107587`
...
2. Clone this repo and `cd testapiautocatalog_107587`
